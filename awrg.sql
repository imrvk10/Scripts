REM Script for creating multiple consecutive Oracle GLOBAL AWR Reports
...
prompt 
prompt Script for creating multiple consecutive Oracle GLOBAL AWR Reports
...
dbms_output.put_line('prompt Creating GLOBAL AWR Report '||v_db_name|| ' DB ' ||v_awr_reportname

REM AWR-Generator.sql: Script for creating multiple consecutive Oracle PDB AWR Reports
REM Please connect to target Pluggable Database.
...
prompt
prompt Script for creating multiple consecutive Oracle PDB AWR Reports
...
-- Iterate through snapshots
 ...
 v_awr_reportname := 'awrrpt_'||v_db_name||cr_snapshot.inst_num||'_'||cr_snapshot.start_snap_id||'_'||cr_snapshot.end_snap_id||v_report_suffix;
 
dbms_output.put_line('prompt Creating AWR Report for '||v_db_name|| ' PDB ' ||v_awr_reportname

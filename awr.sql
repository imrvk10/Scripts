REM Script for creating multiple consecutive Oracle AWR Reports
...
prompt
prompt creating multiple consecutive Oracle AWR Reports
...
dbms_output.put_line('prompt Creating AWR Report '||v_db_name|| ' DB ' ||v_awr_reportname
